...
class Builder
{
    ...
    function __construct($parameters)
    {
        ...
        $oFileName = $parameters['output_filename'];
        $oFileName = str_replace('Lua_', '', $oFileName);
        $this->luaopenFunctionName_ = str_replace('-', '_', sprintf('luaopen_%s', $oFileName));
    }
...
#include "common/lua/MELuaUtils.h"
